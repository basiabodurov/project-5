 ...
 * @author    Basia Bodurov <basiabodurov@gmail.com>
 * @license   GPL-2.0+
 * @link      http://redacademy.com
 * @copyright 2015 Le Red Bread Bakery
 *
 * @wordpress-plugin
 * Plugin Name:       Le Red Bread Bakery Hours Widget
 * Plugin URI:        http://redacademy.com
 * Description:       Business Hours widget for the Le Red Bread Bakery.
 * Version:           1.0.0
 * Author:            Basia Bodurov
...
$instance['sunday'] = strip_tags( $new_instance['sunday'] );
	...
	public function form( $instance ) {
		...
		$title = strip_tags( $instance['title'] ); // no HTML tags
